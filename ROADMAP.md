...
- ⬜ **E4 — Item analysis.** Flag questions everyone fails (training gap or mis-keyed) and questions nobody misses (too easy).
...
- ⬜ **E6 — Attempt controls.** Shuffle MCQ option order per attempt, retake limits, lock a passed exam, optional retrain-before-resit.
- ⬜ **E7 — Pass certificate.** Auto-generated certificate (.doc/PDF) on pass, with name/score/date.
- ✅ **E8 — "Review your mistakes" for takers.** After submitting, the taker reviews each MCQ (their pick vs correct answer), written answers with grader feedback, and a per-topic competency breakdown.
